  ...
  return (
      <aside className='bg-black w-[305px] fixed left-0 flex flex-col px-10 text-[12px]'>
        <section className="flex flex-col items-center gap-2 py-3">
          <Image className='rounded-full' src='/images/propic.jpg' height={130} width={130} alt="Profile Picture"/>
        ...
        <div className="bg-white w-[220px] h-[1.5px] mx-auto"></div>
        <section>
          <SkillContainer Title='Languages' Skills={[
            { 
              Id: "0",
              Skill: "Spanish",
              Progress: "100",
        ...
        <div className="bg-white w-[220px] h-[1.5px] mx-auto"></div>
        <section>
          <SkillContainer Title='Programming Languages' Skills={[
            {
              Id: "0",
              Skill: "Python",
              Progress: "100",
